This folder contains all database-related files, including SQL scripts and resources necessary for managing and maintaining the database. Future updates will include additional queries and utilities.
