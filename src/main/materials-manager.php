...
<body>
    ...
    <div class="sidebar">
        <div class="p-4">
            <h4 class="text-center mb-4">GPLMS</h4>
            <ul class="list-unstyled">
                <li class="mb-2"><a href="dashboard.php"><i class="fas fa-home me-2"></i> Dashboard</a></li>
                <li class="mb-2"><a href="materials-manager.php" class="active"><i class="fas fa-book me-2"></i> Materials</a></li>
                <li class="mb-2"><a href="user-management.php"><i class="fas fa-users me-2"></i> Users</a></li>
                <li class="mb-2"><a href="reports.php"><i class="fas fa-chart-bar me-2"></i> Reports</a></li>
                <li class="mb-2"><a href="settings.php"><i class="fas fa-cog me-2"></i> Settings</a></li>
