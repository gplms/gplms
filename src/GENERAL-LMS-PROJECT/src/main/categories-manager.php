...
<body>
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="categories-manager.php" class="nav-link active">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <?php if ($edit_category): ?>
                            ...
                            <input type="hidden" name="action_type" value="update_category">
                        <?php else: ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select">
                                <option value="active" <?= ($edit_category['status'] ?? 'active') === 'active' ? 'selected' : '' ?>>Active</option>
                                <option value="inactive" <?= ($edit_category['status'] ?? 'active') === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        </div>
                    </div>
