...
<div class="stats-container">
    <div class="stat-card">
        ...
        <div class="stat-number"><?= $stats['users'] ?></div>  <!-- Fixed -->
    ...
    <div class="stat-card">
        ...
        <div class="stat-number"><?= $stats['library_items'] ?></div>  <!-- Fixed -->
    ...
    <div class="stat-card">
        ...
        <div class="stat-number"><?= $stats['authors'] ?></div>  <!-- Fixed -->
    ...
    <div class="stat-card">
        ...
        <div class="stat-number"><?= $stats['recent_activity'] ?></div>  <!-- Fixed -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <!-- In the System Status section -->
<li class="list-group-item d-flex justify-content-between">
    <span>Active Users:</span>
    <span>N/A</span> <!-- Remove PHP reference to active_users -->
</li>
                                </ul>
                            </div>
                        </div>
